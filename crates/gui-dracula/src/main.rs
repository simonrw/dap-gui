    ...
    eframe::run_native(
        ...
        Box::new(|cc| {
            ...
            let style = if is_dark {
                ...
                let background = Color32::from_rgb(40, 42, 54); // #282a36
                let current_line = Color32::from_rgb(68, 71, 90); // #44475a
                let foreground = Color32::from_rgb(248, 248, 242); // #f8f8f2
                let comment = Color32::from_rgb(98, 114, 164); // #6272a4
                let cyan = Color32::from_rgb(139, 233, 253); // #8be9fd
                let purple = Color32::from_rgb(189, 147, 249); // #bd93f9
                let pink = Color32::from_rgb(255, 121, 198); // #ff79c6
                let _red = Color32::from_rgb(255, 85, 85); // #ff5555
                ...
                egui::Style {
                    visuals: Visuals {
                        ...
                        window_fill: current_line,
                        faint_bg_color: current_line,
                        extreme_bg_color: Color32::from_rgb(30, 31, 41),
                        window_corner_radius: corner_radius,
                        window_stroke: Stroke::new(1.0, comment),
                        ...
                        selection: egui::style::Selection {
                            bg_fill: purple.linear_multiply(0.35),
                            stroke: Stroke::new(1.0, purple),
                        },
                        hyperlink_color: cyan,
                        widgets: egui::style::Widgets {
                            noninteractive: egui::style::WidgetVisuals {
                                bg_fill: current_line,
                                weak_bg_fill: current_line,
                                bg_stroke: Stroke::new(1.0, comment),
                                fg_stroke: Stroke::new(1.0, foreground),
                                corner_radius,
                                expansion: 0.0,
                            },
                            inactive: egui::style::WidgetVisuals {
                                bg_fill: Color32::from_rgb(55, 57, 72),
                                weak_bg_fill: Color32::from_rgb(55, 57, 72),
                            ...
                            hovered: egui::style::WidgetVisuals {
                                bg_fill: Color32::from_rgb(78, 81, 102),
                                weak_bg_fill: Color32::from_rgb(78, 81, 102),
                                bg_stroke: Stroke::new(1.0, purple),
                            ...
                            active: egui::style::WidgetVisuals {
                                ...
                                weak_bg_fill: pink,
                                bg_stroke: Stroke::NONE,
                                fg_stroke: Stroke::new(2.0, background),
                                corner_radius,
                                expansion: 0.0,
                            },
                ...
                // Dracula Alucard (light variant)
                use egui::{Color32, CornerRadius, Shadow, Stroke, vec2};
                let bg = Color32::from_rgb(255, 251, 235); // #fffbeb
                let surface = Color32::from_rgb(245, 240, 220);
                let fg = Color32::from_rgb(31, 31, 31); // #1f1f1f
                let fg_dim = Color32::from_rgb(80, 80, 80);
                let selection = Color32::from_rgb(207, 207, 222); // #cfcfde
                let accent = Color32::from_rgb(130, 80, 220);
                let border = Color32::from_rgb(200, 200, 210);
                let corner_radius = CornerRadius::same(6);
                egui::Style {
                    visuals: Visuals {
                        dark_mode: false,
