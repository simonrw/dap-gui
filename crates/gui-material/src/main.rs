    ...
    eframe::run_native(
        ...
        Box::new(|cc| {
            ...
            let style = if is_dark {
                // Material Design 3 — Dark scheme (baseline purple)
                use egui::{Color32, CornerRadius, Margin, Shadow, Stroke, vec2};
                let surface = Color32::from_rgb(20, 18, 24); // #141218
                let surface_cont = Color32::from_rgb(33, 31, 38); // #211f26
                let surface_high = Color32::from_rgb(43, 41, 48); // #2b2930
                let surface_bright = Color32::from_rgb(59, 56, 62); // #3b383e
                let on_surface = Color32::from_rgb(230, 225, 229); // #e6e1e5
                let on_surface_var = Color32::from_rgb(202, 196, 208); // #cac4d0
                let primary = Color32::from_rgb(208, 188, 255); // #d0bcff
                let on_primary = Color32::from_rgb(56, 30, 114); // #381e72
                let outline = Color32::from_rgb(147, 143, 153); // #938f99
                let outline_var = Color32::from_rgb(73, 69, 79); // #49454f
                let _error = Color32::from_rgb(242, 184, 181); // #f2b8b5
                let rounding = CornerRadius::same(12);
                let widget_rounding = CornerRadius::same(12);
                egui::Style {
                    visuals: Visuals {
                        dark_mode: true,
                        override_text_color: Some(on_surface),
                        panel_fill: surface,
                        window_fill: surface_cont,
                        faint_bg_color: surface_cont,
                        extreme_bg_color: Color32::from_rgb(14, 12, 16),
                        window_corner_radius: rounding,
                        window_stroke: Stroke::new(1.0, outline_var),
                        ...
                        selection: egui::style::Selection {
                            bg_fill: Color32::from_rgb(103, 80, 164).linear_multiply(0.4),
                            stroke: Stroke::new(1.0, primary),
                        },
                        hyperlink_color: primary,
                        widgets: egui::style::Widgets {
                            noninteractive: egui::style::WidgetVisuals {
                                bg_fill: surface_cont,
                                weak_bg_fill: surface_cont,
                                bg_stroke: Stroke::new(1.0, outline_var),
                                fg_stroke: Stroke::new(1.0, on_surface_var),
                                corner_radius: widget_rounding,
                                expansion: 0.0,
                            },
                            inactive: egui::style::WidgetVisuals {
                                bg_fill: surface_high,
                                weak_bg_fill: surface_high,
                                bg_stroke: Stroke::NONE,
                                fg_stroke: Stroke::new(1.0, on_surface),
                                corner_radius: widget_rounding,
                                expansion: 0.0,
                            },
                            hovered: egui::style::WidgetVisuals {
                                bg_fill: surface_bright,
                                weak_bg_fill: surface_bright,
                                bg_stroke: Stroke::new(1.0, outline),
                                fg_stroke: Stroke::new(1.5, on_surface),
                                corner_radius: widget_rounding,
                                expansion: 1.0,
                            },
                            active: egui::style::WidgetVisuals {
                                ...
                                bg_stroke: Stroke::NONE,
                                fg_stroke: Stroke::new(2.0, on_primary),
                                corner_radius: widget_rounding,
                                expansion: 0.0,
                            },
                ...
                use egui::{Color32, CornerRadius, Margin, Shadow, Stroke, vec2};
                let surface = Color32::from_rgb(254, 247, 255); // #fef7ff
                let surface_cont = Color32::from_rgb(243, 237, 247); // #f3edf7
                let surface_high = Color32::from_rgb(231, 224, 236); // #e7e0ec
                let surface_bright = Color32::from_rgb(255, 251, 254);
                let on_surface = Color32::from_rgb(28, 27, 31); // #1c1b1f
                let on_surface_var = Color32::from_rgb(73, 69, 79); // #49454f
                let primary = Color32::from_rgb(103, 80, 164); // #6750a4
                let on_primary = Color32::WHITE;
                let outline = Color32::from_rgb(121, 116, 126); // #79747e
                let outline_var = Color32::from_rgb(196, 199, 197); // #c4c7c5
                let _error = Color32::from_rgb(179, 38, 30); // #b3261e
                let rounding = CornerRadius::same(12);
                let widget_rounding = CornerRadius::same(12);
                egui::Style {
                    visuals: Visuals {
                        ...
                        menu_corner_radius: rounding,
                        selection: egui::style::Selection {
                            bg_fill: Color32::from_rgb(103, 80, 164).linear_multiply(0.2),
                            stroke: Stroke::new(1.0, primary),
                        },
                        hyperlink_color: primary,
                        widgets: egui::style::Widgets {
