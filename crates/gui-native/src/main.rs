    ...
    eframe::run_native(
        ...
        Box::new(|cc| {
            ...
            let style = if is_dark {
                ...
                let bg = Color32::from_rgb(30, 30, 30); // #1e1e1e
                let surface = Color32::from_rgb(42, 42, 42); // #2a2a2a
                let surface_high = Color32::from_rgb(55, 55, 55);
                let text = Color32::from_rgb(230, 230, 230);
                let text_dim = Color32::from_rgb(170, 170, 170);
                let accent = Color32::from_rgb(10, 132, 255); // #0a84ff iOS blue
                let border = Color32::from_rgb(65, 65, 65);
                let panel_rounding = CornerRadius::same(8);
                ...
                egui::Style {
                    visuals: Visuals {
                        ...
                        window_corner_radius: panel_rounding,
                        ...
                        menu_corner_radius: panel_rounding,
                        ...
                        widgets: egui::style::Widgets {
                            ...
                            hovered: egui::style::WidgetVisuals {
                                ...
                                bg_stroke: Stroke::new(1.0, Color32::from_rgb(85, 85, 85)),
                ...
                use egui::{Color32, CornerRadius, Margin, Shadow, Stroke, vec2};
                let bg = Color32::from_rgb(246, 246, 246); // #f6f6f6
                let surface = Color32::WHITE;
                let surface_dim = Color32::from_rgb(232, 232, 232);
                let text = Color32::from_rgb(30, 30, 30);
                let text_dim = Color32::from_rgb(100, 100, 100);
                let accent = Color32::from_rgb(0, 122, 255); // #007aff iOS blue
                    ...
                    visuals: Visuals {
                        ...
                        widgets: egui::style::Widgets {
                            ...
                            hovered: egui::style::WidgetVisuals {
                                ...
                                bg_stroke: Stroke::new(1.0, Color32::from_rgb(195, 195, 195)),
                                fg_stroke: Stroke::new(1.5, text),
                                corner_radius: widget_rounding,
                                expansion: 1.0,
                            },
