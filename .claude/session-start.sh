...
# Update apt cache and install any required system packages
# (Currently the project doesn't require additional system packages beyond base Ubuntu)
echo "📦 Updating apt cache..."
apt-get update -qq

# Optional: Install additional packages if needed in the future
